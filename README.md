...
最新源码对照与后续优化建议见 [AI 酒馆实现对照与剧本杀项目优化建议](docs/ai-roleplay-optimization-2026-09-15.md)，包含条件秘密、公开证据保留、向量模型隔离、上下文预算与对局质量评估。

剧本创作与内容优化见 [剧本杀设计方法与当前剧本库优化手册](docs/script-design-playbook-2026-09-15.md)，包含剧情与证据设计、角色互动、分幕与主持节奏、审稿模板和试演流程。
